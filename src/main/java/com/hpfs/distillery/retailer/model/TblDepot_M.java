...
@Entity
@Table(name="depot_m")
public class TblDepot_M {

	@Override
	public String toString() {
		return "TblDepot_M [depotId=" + depotId + ", depotName=" + depotName + ", location=" + location + ", address="
				+ address + ", district=" + district + ", state=" + state + ", countryCode=" + countryCode + ", status="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TblDepot_M other = (TblDepot_M) obj;
		if (address == null) {
