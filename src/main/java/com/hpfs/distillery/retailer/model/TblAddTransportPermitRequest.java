...
public class TblAddTransportPermitRequest {
...
//	@GeneratedValue(strategy=GenerationType.AUTO)
	...
	public Long qtyInCases;

	@Column(name = "rate_per_case")
	public Float ratePerCase;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TblAddTransportPermitRequest other = (TblAddTransportPermitRequest) obj;
		if (brandName == null) {
